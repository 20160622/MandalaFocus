...
function preload() {
  patternShader = loadShader('shaders/pattern.vert?v=23', 'shaders/pattern.frag?v=23');
}
...
function windowResized() {
  fitToViewport();
  // iOS/Android では回転直後に innerWidth/Height がまだ確定しておらず、
  // 古い寸法でリサイズされて画面の一部が黒く残ることがある。
  // レイアウトが落ち着いてから二度ほど再適用して取りこぼしを防ぐ。
